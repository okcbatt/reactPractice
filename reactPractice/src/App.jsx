      ...
      <div>
        ...
        */}
        <form onSubmit={sendNewPostReq}>
          <label htmlFor="blog-post-title">New Blog Title:</label>
          <input
            name="blog-post-title"
            type="text"
            placeholder="New Blog Title Goes Here"
            value={newPostTitle}
            onChange={(event) => {
              setNewPostTitle(event.target.value);
            }}
          ></input>
          <label htmlFor="blog-post-body">Blog:</label>
          <input
            name="blog-post-body"
            type="text"
